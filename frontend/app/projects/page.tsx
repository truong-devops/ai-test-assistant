            ...
            <table className="data-table">
              ...
              <tbody>{projects.map((project) => {
                ...
                return <tr key={project.id}>
                  <td><Link href={`/projects/${project.id}`}><span className="table-title">{project.name}</span><span className="table-subtitle">GitLab #{project.gitlab_project_id} · {project.language.toUpperCase()}</span></Link></td>
