...
export default async function TestCaseDetailPage({ params, searchParams }: {
  ...
  return <AppShell active="documents">
    {item.needs_source_review ? <p className="notice">Requirement nguồn đã thay đổi hoặc không còn trong phạm vi. Revision testcase này cần xem lại trước khi chốt bộ mới; nội dung và kết quả chạy lịch sử vẫn được giữ.</p> : null}
	{created ? <p className="notice"><strong>Revision {created} was created.</strong> You are reviewing the new immutable revision.</p> : null}
