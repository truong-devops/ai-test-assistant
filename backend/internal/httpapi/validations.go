...
func (h validationHandler) list(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		writeError(w, http.StatusInternalServerError, "could not list validation runs")
		return
	}
	writeJSON(w, http.StatusOK, map[string]any{"validation_runs": results})
}
